...
<body>
<div class="container">
  <h3 style="font-weight: bold; text-align: center;">Peer Registration</h3><hr><br>
  <form method="POST" action="peer_engine.php" enctype="multipart/form-data">
    ...
    <hr>
    <center><button id="submit" name="peer_register" class="btn btn-primary btn-block" onclick="return Validate()">Register</button></center><br>
